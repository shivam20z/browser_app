...
public class instagram extends AppCompatActivity implements View.OnTouchListener {
    WebView webViewinsta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webViewinsta=findViewById( R.id.webviewinsta );
        ...
        fab1.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText( instagram.this,"Up",Toast.LENGTH_SHORT ).show();

                webViewinsta.scrollTo(0,0);
                try {
                    sleep( 300 );
        ...
        btn2.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WebSettings webSettings=webViewinsta.getSettings();
        ...
        webViewinsta.setWebChromeClient( new WebChromeClient() {
