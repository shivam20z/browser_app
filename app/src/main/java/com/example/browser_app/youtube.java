...
public class youtube extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab1.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText( youtube.this,"Up",Toast.LENGTH_SHORT ).show();

                webViewyoutube.scrollTo(0,0);
                try {
                    sleep( 300 );
